...
Let's start by quickly looking at the technical specifications of AWS Lambda. Lambda supports the following runtimes ([source](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html)).
